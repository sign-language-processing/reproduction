...
- The official LSA64 page currently licenses the data CC BY-NC-ND 4.0 for strict academic use and prohibits derivative works. No dataset, predictions, or weights are committed or publicly distributed. The permission basis for publishing a learned checkpoint must be resolved before any model upload.
